...
ifeq (2, $(BRANCH_NUM))
	VCS += +define+N=$(N_NUM)+RS_NUM_ENTRIES=$(RS_NUM)+ROB_NUM_ENTRIES=$(ROB_NUM)+ICACHE_NUM_LINES=$(CACHE_NUM)+DCACHE_NUM_LINES=$(CACHE_NUM)+MEM_LATENCY_IN_MS=$(MEM_NUM)+LOCAL_HIST_BRANCH_TYPE+
endif
ifeq (3, $(BRANCH_NUM))
	VCS += +define+N=$(N_NUM)+RS_NUM_ENTRIES=$(RS_NUM)+ROB_NUM_ENTRIES=$(ROB_NUM)+ICACHE_NUM_LINES=$(CACHE_NUM)+DCACHE_NUM_LINES=$(CACHE_NUM)+MEM_LATENCY_IN_MS=$(MEM_NUM)+LOCAL_BRANCH_TYPE+
endif
